    ...
    const datas = [
      {
        ...
        message: 'Use 1982 to verify your account',
      },
      {
        phoneNumber: '98877665544',
        message: 'Use 1738 to verify your account',
      },
    ];
    createPushNotificationsJobs(datas, QUEUE);
    expect(QUEUE.testMode.jobs.length).to.equal(2);
    expect(QUEUE.testMode.jobs[0].data).to.deep.equal(datas[0]);
